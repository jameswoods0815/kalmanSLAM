...
def visualize_trajectory_2d_1(pose,map=None, path_name="Unknown",show_ori=False):
    '''
    ...
    if map is not None:
     ax.scatter(map[:,0],map[:,1],s=10.0,  color=LANDMARK_COLOR,marker='o',  linewidths=0.1)
